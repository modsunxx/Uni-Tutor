...
export default function LoginPage() {
  ...
  const handleGoogleLogin = async () => {
    ...
    // กดล็อกอินแล้วตั้งค่าให้ redirect ไปที่หน้า /register ก่อน
    // เพราะหน้า register เราเขียนระบบเช็คเอาไว้แล้วว่า "ถ้ามีข้อมูลในตาราง users แล้ว ให้เด้งไปหน้า /search ทันที"
    ...
    <main className="min-h-screen bg-gray-50 flex items-center justify-center p-4 py-12">
      <div className="bg-white w-full max-w-md rounded-2xl shadow-lg p-8 border border-gray-100">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-500 mt-2">ยินดีต้อนรับกลับสู่ Uni-Tutor</p>
        </div>
